		...
		<header>
			<div id="header-shadow">
				<div id="header-wrapper">
					<div id="company-logo">
						<a href="<?php echo home_url() ; ?>"><img alt="penguin air & plumbing" src="<?php echo get_template_directory_uri(); ?>/images/penguin.png" title="penguin air & plumbing"></a>
					</div>
					<div id="review_buzz">
						<!--Begin REVIEWBUZZ widget--><script type="text/javascript" src="http://www.reviewbuzz.com/app/public/js/widget.js?id=1958"></script>
						<noscript><a href="http://www.reviewbuzz.com/web-widget/PenguinAirHomeServices" style="font-size:12px;"><img width="170" style="cursor: pointer" src="http://www.reviewbuzz.com/app/public/images/popup-widget/reviewbuzz_widget_icon.png" alt="Penguin Air & Home Services - 0 Customer Reviews - Tempe, AZ"><br>Penguin Air & Home Services - 0 Customer Reviews - Tempe, AZ</a></noscript><!--End REVIEWBUZZ widget-->
					</div>
					<div id="call-to-action">
						<div>
							<p>CALL <br>NOW!</p>
							<span>480-747-6803</span>
						</div>
					</div>
					<div class="clear"></div>
				</div>
