<section id="main-container">
		...
		<div id="header-mobile-wrapper">
			<div>
				<div id="logo-mobile">
					...
					<a href="<?php echo home_url() ?>"><img alt="company logo" id="company-logo-mobile" src="<?php echo get_template_directory_uri(); ?>/images/penguin-mobile-button.png" title="company-logo"></a>
				</div>		
				<div id="call-to-action-mobile">
					<a href="tel:14807476803"><img alt="company logo" id="phone-button-mobile" src="<?php echo get_template_directory_uri(); ?>/images/phone-button.png" title="company-logo"></a>
	...
	<div class="off-canvas" title="mobile-contact">
		...
		<div id="contact-form-mobile">
			<form id="form271" name="form271" class="wufoo rightLabel page" accept-charset="UTF-8" autocomplete="off" enctype="multipart/form-data" method="post" validate action="https://vitalstorm.wufoo.com/forms/m1hw9g0g0e9081q/#public">
				...
				<div id="mobile_form_body">
					...
					<div class="submit">
						...
						<div class="hide">
							...
							<input type="hidden" id="idstamp" name="idstamp" value="l3BqDymtvUz27aas/3NHDX06XiXPRu5FT8J0CZN/lF4=" />
						</div>
					</div>
					<div class="clear"></div>
				</div>
